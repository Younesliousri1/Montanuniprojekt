...
with tab_stats:
    ...
    with col1:
        ...
        if p_value > 0.05:
            ...
            st.markdown("We *reject* the null hypothesis. This is common with small sample sizes (like 21).")
        st.markdown("*(Note: This test has low power with small samples, so G1 (21) may fail even if it looks normal.)*")
...
with tab_info:
    ...
    * [cite_start]**Group 1 ($G_1$):** Repeat this experiment 21 times[cite: 6, 9].
